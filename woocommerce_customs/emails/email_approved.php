...
add_action( 'woocommerce_order_status_ayala_approved', 'bbloomer_status_custom_notification_ayala_approved', 20, 2 );
  
function bbloomer_status_custom_notification_ayala_approved( $order_id, $order ) {
    ...
    $email_info = array(
        array(
            ...
            "message" => "
                ...
                <p>A new meeting room booking request for ".getDateFromDateTimeString($checkin).", ".getTimeFromDateTimeString($checkin)." - ".getTimeFromDateTimeString($checkout)." has been booked.</p>
                <p>Kindly refer to the booking details attached:</p>
            ...
            ",
            "subject" => $email_from.' | New Confirmed Room Booking'
        ),
        array(
            "name" => $author_name,
            "email" => $author_email,
        ...
        array(
            ...
            <p>We are pleased to inform you that your meeting room booking request for ".getDateFromDateTimeString($checkin).", ".getTimeFromDateTimeString($checkin)." - ".getTimeFromDateTimeString($checkout)." has been confirmed. Kindly refer to the booking details attached:</p>
