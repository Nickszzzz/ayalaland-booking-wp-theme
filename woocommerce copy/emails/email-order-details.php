...
$date_time_object = DateTime::createFromFormat('D M d Y H:i:s', $checkin);

 // Format the date as "December 4, 2023"
 $formatted_date = $date_time_object ? $date_time_object->format('F j, Y') : 'Invalid date';

if (!function_exists('formatTime')) {
    function formatTime($date_time_string, $output_format = 'g:i a') {
		// Convert the date and time string to a DateTime object
		$date_time_object = DateTime::createFromFormat('D M d Y H:i:s', $date_time_string);
...
<p><?php echo $checkin_time; ?> to <?php echo $checkout_time; ?> </p>
<br>
