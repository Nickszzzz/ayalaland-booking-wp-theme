<div class="gf_browser_gecko gform_wrapper gravity-theme gform-theme--no-framework advance__search_wrapper"
    ...
    <style>
        ...
        .advance__search .gform_body .gform_fields {
            display: flex;
        }
    </style>
    <form method="post" enctype="multipart/form-data" id="gform_1" class="advance__search" action="<?php echo home_url().'/meeting-rooms'; ?>"
        data-formid="1" novalidate="">
        <div class="gform-body gform_body">
            <div id="gform_fields_1" class="gform_fields top_label form_sublabel_below description_below">
                <div id="field_1_8"
                    class="gfield gfield--type-text gfield--width-quarter field_sublabel_below gfield--no-description field_description_below hidden_label gfield_visibility_visible"
                    data-js-reload="field_1_8">
                    <div class="ginput_container ginput_container_text"><input name="input_8" id="input_1_8" type="text"
                            value="" class="large" placeholder="Search Location" aria-invalid="false"> </div>
                </div>
                <div id="field_1_16"
                    class="gfield gfield--type-number gfield--width-quarter field_sublabel_below gfield--no-description field_description_below hidden_label gfield_visibility_visible"
                    data-js-reload="field_1_16">
                    <div class="ginput_container ginput_container_number"><input name="input_16" id="input_1_16"
                ...
                <div id="field_1_10"
                    ...
                    <div class="ginput_container ginput_container_date">
                        <input name="input_10" id="input_1_10" type="text" value=""
                            ...
                            placeholder="Check-In" aria-describedby="input_1_10_date_format" aria-invalid="false">
                ...
                <div id="field_1_14"
                    ...
                    <div class="ginput_container ginput_container_date">
                        <input name="input_14" id="input_1_14" type="text" value=""
                            class="datepicker gform-datepicker mdy datepicker_no_icon gdatepicker-no-icon hasDatepicker initialized"
                            placeholder="Check-Out" aria-describedby="input_1_14_date_format" aria-invalid="false">
        ...
        <div class="gform_footer top_label"> <input type="submit" id="gform_submit_button_1" class="gform_button button"
                value="Search"
            ...
            <input type="hidden" class="gform_hidden" name="state_1"
                value="WyJbXSIsIjQ3ZjJlZDc0ZTkxZTIzMGIyNDZkMjRmNTVmMDU1ZGJjIl0=">
            <input type="hidden" class="gform_hidden" name="gform_target_page_number_1" id="gform_target_page_number_1"
                value="0">
            <input type="hidden" class="gform_hidden" name="gform_source_page_number_1" id="gform_source_page_number_1"
                value="1">
