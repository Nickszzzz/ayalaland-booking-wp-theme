                    ...
                    <div id="order_review" class="woocommerce-checkout-review-order">
                        <?php 
                           ...
                           function convertDateFormat($inputDate) {
                                ...
                                $outputDate = $dateTime->format('m-d-y g:i a');
                        ...
                        <table class="">
                            ...
                            <body>
                                <tr class="">
                                    ...
                                    <td class="product-total">
                                        ...
                                        if (stripos($rate, 'Hourly') !== false) {
                                            ...
                                            $total_booking_amount = calculateDailyCost($total_amount, $hoursDifference);
                                            echo number_format((float)$total_booking_amount, 2, '.', ',');
                                        }
                                ...
                                <tr class="">
                                    ...
                                    <td class="product-total">
                                        Php <?php 
                                              echo number_format((float)$total_booking_amount+50, 2, '.', ',');?>
                                        <input type="hidden" name="overall_total"
                                            value="<?php echo $total_booking_amount+50; ?>">
                                    </td>
                                </tr>
                            </body>
