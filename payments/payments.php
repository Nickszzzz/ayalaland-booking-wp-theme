...
function enqueue_custom_scripts_styles_payments($hook_suffix) {
    if ($hook_suffix === 'toplevel_page_payments_options') {
        ...
        wp_enqueue_style('custom-style', get_stylesheet_directory_uri() . '/payments/index-l4Ww4r7b.css');
        // Enqueue your JavaScript file
        wp_enqueue_script('custom-script', get_stylesheet_directory_uri() . '/payments/index-DMwlVRpA.js', array(), null, true);
    }
}
