...
function enqueue_custom_scripts_styles($hook) {
    ...
    if ('booking' == $post_type && in_array($hook, array('post-new.php', 'post.php'))) {
        ...
        wp_enqueue_style('custom-style', get_stylesheet_directory_uri() . '/bookings/index-DRf6RnTg.css');
        // Enqueue your JavaScript file
        wp_enqueue_script('custom-script', get_stylesheet_directory_uri() . '/bookings/index-bKgpVs5v.js', array(), null, true);
    }
}
